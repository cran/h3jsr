...
test_that(
  'h3_to_line returns correctly - list of vectors',
  c(path <- c("8abe8d12adaffff", "8abe8d10536ffff", "8abe8d10526ffff",
              "8abe8d12a52ffff", "8abe8d12aceffff", "8abe8d12ac2ffff"),
    paths <- list(path, path, path),
    val1 <- h3_to_line(paths),
    val2 <- h3_to_line(paths, simple = FALSE),
    expect_is(val1, 'sfc_LINESTRING'),
...
test_that(
  'h3_to_line returns correctly - data.frame with list-column',
  c(library(sf),
    ...
    val1 <- h3_to_line(paths_df),
    val2 <- h3_to_line(paths_df, simple = FALSE),
    expect_is(val1, 'sfc_LINESTRING'),
